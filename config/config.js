  ...
  Telenot: {
    ...
    MELDEBEREICHE: {
      ...
      positions: [
        ...
        { hex: 0x85, name: 'Tür Essen/Wohnen', topic: 'telenot/alarm/mb/fenster_eg_essen_wz', inverted: true },
        { hex: 0x86, name: 'Fenster Gäste WC', topic: 'telenot/alarm/mb/fenster_eg_gaeste_wc', inverted: true },
        { hex: 0x87, name: 'Fenster Gästezimmer', topic: 'telenot/alarm/mb/fenster_eg_gast', inverted: true },
        ...
        { hex: 0x44, name: 'Störung', topic: 'telenot/alarm/mb/stoerung', inverted: true },
    ...
    MELDEGRUPPEN: {
      ...
      positions: [
        ...
        { hex:0x6, name: 'Fenster Gäste WC', topic: 'telenot/alarm/mg/fenster_gäste_wc', inverted: true },
        { hex:0x7, name: 'Tür Gästezimmer', topic: 'telenot/alarm/mg/tür_gästezimmer', inverted: true },
